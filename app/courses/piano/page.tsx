    ...
    <>
      ...
      <main style={{ paddingTop: 68 }}>
        ...
        <div style={{ background: green, position: "relative", overflow: "hidden" }}>
          <div style={{ position: "absolute", inset: 0, backgroundImage: "url(https://greenroomtheory.com/wp-content/uploads/2025/09/014-GreenRoomMusicTheorySummer2025-scaled.jpg)", backgroundSize: "cover", backgroundPosition: "center", opacity: 0.25 }} />
          <div style={{ position: "relative", zIndex: 1, maxWidth: 1200, margin: "0 auto", padding: "80px 24px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 48, alignItems: "center" }}>
            <div>
              <p style={{ color: gold, fontSize: "0.7rem", textTransform: "uppercase", letterSpacing: "0.2em", marginBottom: 16, fontFamily: I }}>Course — Piano</p>
              <h1 style={{ fontFamily: G, fontSize: "clamp(2.5rem, 5vw, 4rem)", fontWeight: 500, color: "#fff", marginBottom: 20, lineHeight: 1.15 }}>Piano</h1>
              <p style={{ color: "rgba(255,255,255,0.65)", lineHeight: 1.75, marginBottom: 32, maxWidth: 480, fontSize: "0.95rem" }}>
                An intensive week of daily piano tuition, masterclasses, ensemble performance and an evening recital — designed for dedicated students at Grade 4 and above.
              </p>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2 }}>
              {[["Grade", "4–8"], ["Duration", "5 Days"], ["Ages", "10–17"], ["Year", "2027"]].map(([label, value]) => (
        ...
        <section style={{ background: cream, padding: "80px 24px" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 48 }}>
            <div style={{ gridColumn: "span 2" }} className="lg:col-span-2">
              <h2 style={{ fontFamily: G, fontSize: "clamp(1.6rem, 3vw, 2.2rem)", fontWeight: 500, color: green, marginBottom: 16 }}>About the Piano Course</h2>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              <div style={{ background: green, padding: "32px" }}>
                ...
                <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: 12 }}>
                  {["Daily individual piano lesson", "Group masterclasses", "Sight-reading workshops", "Technique & scales sessions", "Evening recital performance", "Full board accommodation", "Pastoral support throughout"].map(item => (
